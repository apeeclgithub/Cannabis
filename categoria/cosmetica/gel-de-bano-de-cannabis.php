...
<html lang="es">
	<head>
		...
		<title>Gel de baño de cannabis - EVN</title>
			...
			<div class="cont_prod">
				<section>
					<article class="detalle">
						<div class="img_detalle"><img src="../../img/cosmeticaV2/gel-de-ba%C3%B1o.JPG" alt="gel de baño de cannabis" title="Gel de baño de cannabis"></div>
						<div class="det_producto">
							<div class="nombre_item">GEL DE BAÑO DE CANNABIS</div>
							<select id="region">
							...
							<p class="text_descrip">Descripción:<br><br>Producto enriquecido con Aceite 100% puro de Cannabis Sativa, el cual provoca en su piel hidratación y nutrición dejándola suave y confortable durante todo el día. PH neutro para uso familiar.<br><br>Contenido Neto de cada uno: 400 ml.</p>
						</div>
					</article>
				</section>
			</div>
