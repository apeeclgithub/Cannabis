...
<label for="tab-2">Modifique sus datos</label>
    ...
    ?>
    <fieldset>
        <form id="modifica" name="modifica" method="post" action="function/modifica.php" onchange="CargarComunas(this.value);">
            ...
            <?php
                $query = 'SELECT reg_id, reg_nombre FROM region Where reg_id != 0'; 
            ...
            <label id="comuna_label">Comuna</label>
