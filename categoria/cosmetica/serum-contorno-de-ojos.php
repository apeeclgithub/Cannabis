...
<html lang="es">
	<head>
		...
		<title>Serum contorno de ojos - EVN</title>
			...
			<div class="cont_prod">
				<section>
					<article class="detalle">
						<div class="img_detalle"><img src="../../img/cosmeticaV2/contorno-de-ojos.JPG" alt="serum contorno de ojos" title="Serum contorno de ojos"></div>
