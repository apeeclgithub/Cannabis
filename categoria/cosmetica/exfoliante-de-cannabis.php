...
<head>
    ...
    <title>Exfoliante de cannabis - EVN</title>
            ...
            <div class="cont_prod">
                <section>
                    <article class="detalle">
                        <div class="img_detalle"><img src="../../img/9.png" alt="exfoliante de cannabis" title="Exfoliante de cannabis"></div>
                        <div class="det_producto">
                            <div class="nombre_item">EXFOLIANTE DE CANNABIS</div>
                            <select id="region">
                            ...
                            <h3 class="text_descrip">Precio: $3.900</h3>
                            ...
                            <p class="text_descrip">Descripción:<br><br>Exfoliante de cáñamo limpia y suaviza profundamente la piel, impidiendo la acumulación de toxinas, acelera la circulación sanguínea, aumenta la oxigenación de la piel, mejora la absorción, gracias a  los principios activos de los aceites.<br><br>Contenido Neto: 100 grs.</p>
                        </div>
                    </article>
                </section>
            </div>
