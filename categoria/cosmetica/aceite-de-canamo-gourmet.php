...
<html lang="es">
	<head>
		...
		<title>Aceite de Cáñamo Gourmet - EVN</title>
			...
			<div class="cont_prod">
				<section>
					<article class="detalle">
						<div class="img_detalle"><img src="../../img/cosmeticaV2/aceite-gourmet.JPG" alt="aceite de cáñamo gourmet" title="Aceite de cáñamo gourmet"></div>
						<div class="det_producto">
							<div class="nombre_item">ACEITE DE CÁÑAMO GOURMET</div>
							<select id="region">
							...
							<p class="text_descrip">Descripción:<br><br>Aceite Gourmet 100% puro Semilla de cáñamo. Rico en Omegas 3 - 6 y 9.<br><br>Ingredientes: Aceite de semilla de cáñamo (cannabis sativa, orgánico), menor al 0.4% de acidez.<br><br>Contenido Neto: 250 grs.</p>
						</div>
					</article>
				</section>
			</div>
