...
<html lang="es">
	<head>
		...
		<title>Jabón de cannabis - EVN</title>
			...
			<div class="cont_prod">
				<section>
					<article class="detalle">
						<div class="img_detalle"><img src="../../img/cosmeticaV2/jabon-barra.JPG" alt="jabon de cannabis" title="Jabón de cannabis"></div>
						<div class="det_producto">
							<div class="nombre_item">JABÓN DE CANNABIS</div>
							<select id="region">
							...
							<h3 class="text_descrip">Precio: $3.500</h3>
							...
							<p class="text_descrip">Descripción:<br><br>Jabón de Cannabis elaborado a base de aceite de semilla de cáñamo 100% puro, cuyos componentes naturales como Omega 3 y Omega 6 regeneran y aumentan la resistencia y elasticidad de la piel. Recomendado para pieles dañadas, sensibles o secas. Así como para el cuidado de pieles quemadas. (Producto antiedad, de uso frecuente).</p>
						</div>
					</article>
				</section>
			</div>
